...
- Read-only Q&A now allows four total complete answer operations for transient
  Bedrock or missing structured-submission failures, using 0.25, 0.5, and 1.0
  second backoffs. It reports separate failure counts while keeping unrelated
  validation failures and all write workflows non-retryable.
